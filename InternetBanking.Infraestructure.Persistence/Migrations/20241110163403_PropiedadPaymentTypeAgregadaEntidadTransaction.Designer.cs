...
namespace InternetBanking.Infraestructure.Persistence.Migrations
{
    ...
    [Migration("20241110163403_PropiedadPaymentTypeAgregadaEntidadTransaction")]
    partial class PropiedadPaymentTypeAgregadaEntidadTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InternetBanking.Core.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<string>("DestinationProductId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
